  ...
  <div class="min-h-full">
          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <x-navlink href="/form" :active="request() -> is('form')">Form</x-navlink>
      ...
      <div class="md:hidden" id="mobile-menu">
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
          <div class="flex items-center px-5">
            ...
            <div class="ml-3">
              <div class="text-base font-medium leading-none text-white">KK</div>
              <div class="text-sm font-medium leading-none text-gray-400">KK@example.com</div>
            </div>
    ...
    <header class="bg-white shadow">
      <div class="flex justify-between mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        @guest
          <a href="/login" class="btn btn-primary" >LogIn <i class="pr-1 fa-solid fa-right-to-bracket"></i></a>
        @endguest

        @auth
          <form action="/logout" method="POST">
            @csrf
            <button  class="btn btn-primary">Logout<i class="fa-solid fa-right-to-bracket"></i></button>
          </form>
        @endauth
