...
<?php $component->withAttributes([]); ?>
    <div> <?php $__env->slot('heading', null, []); ?> Contact Page <?php $__env->endSlot(); ?></div>
    
    <div class=" bg-white px-6 py-24 sm:py-32 lg:px-8">
        
        <div class="mx-auto max-w-2xl text-center">
          <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Contact Us</h2>
          <p class="mt-2 text-lg leading-8 text-gray-600">Email at customer.support@test.com</p>
        </div>
        <form action="#" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
          <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
            ...
            <div class="sm:col-span-2">
              ...
              <div class="mt-2.5">
                <input type="text" name="company" id="company" autocomplete="organization" class="focus:none block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
              </div>
            </div>
            <div class="sm:col-span-2">
...
<?php endif; ?><?php /**PATH C:\VSCODE FILES\.vscode\php\laravel\Tasks\resources\views/contact.blade.php ENDPATH**/ ?>